...
- **Een kaart met alle adressen van de stad.** Klik een speld aan voor de scholen die er staan.
  ...
  tot Zeebrugge, en met één klik zit je in het centrum. Zet je JavaScript uit, dan verdwijnt de
  kaart en blijft de volledige lijst eronder gewoon staan.
...
- **Onderaan de pagina staat nu een badge van Simple Analytics, naast de steunknop.** Die dienst
  ...
  geen extra verbinding voor. In het donkere thema kleurt de badge mee met de steunknop.
- **Ook de uitleg over het secundair en over aanmelden en inschrijven wordt nu geteld.** Tot nu
  telde Simple Analytics enkel de zoeker. Dezelfde regels gelden: geen cookies, en wie Do Not
  Track aan heeft staan, telt niet mee. Onderaan die pagina's staat nu ook de badge.
...
- **Google toont de site nu met haar naam.** In de zoekresultaten stond tot nu toe enkel
  "zoekjeschool.be" boven de link. De startpagina vertelt Google nu dat de site "Zoek je school"
  heet, en de twee uitlegpagina's geven hun plaats in de site mee, zodat je boven zo'n resultaat
