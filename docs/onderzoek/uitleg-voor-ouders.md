# Uitleg voor ouders — bronnen voor de eerste graad, aanmelden en inschrijven

Onderzocht 06 en 07/09/2026. **Gebouwd en uitgebracht in 2.2.0 en 2.3.0**, dus dit is
naslagwerk: de bronnen, wat er wel en niet in staat, en de valkuilen bij het herschrijven.
De pagina's zelf zijn `uitleg/index.html` en `uitleg/inschrijven/index.html`.

Wat je hier zeker moet lezen vóór je aan die teksten raakt: Onderwijskiezer verbiedt kopiëren,
de officiële term is "differentiatie" en niet "keuzegedeelte", en de A-stroom sluit de
arbeidsmarktfinaliteit niet uit terwijl de B-stroom doorstroom niet uitsluit (artikel 19 en 20
